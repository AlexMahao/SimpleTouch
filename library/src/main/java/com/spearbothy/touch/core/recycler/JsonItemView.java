package com.spearbothy.touch.core.recycler;
...
import static com.spearbothy.touch.core.recycler.JsonViewerAdapter.BRACES_COLOR;
...
public class JsonItemView extends LinearLayout {
    ...
    private void initView() {
        ...
        LayoutInflater.from(mContext).inflate(R.layout.simple_touch_layout_item_view, this, true);
    ...
    public void setTextSize(float textSizeDp) {
        ...
        mTvRight.setTextColor(BRACES_COLOR);
